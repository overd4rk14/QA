...
2. На основе чек-листа по проверке раздела «Как мы учим» https://21-school.ru/methodology  «Школы 21», разработанного тобой в Задании 2 проекта QA2_Test artifacts предложи минимум 2 варианта тестового тура.
3. Для каждого выбранного тестового тура опиши суть каждого в чем его особенность при выполнении тестирования:
...
3. Сравни туры: опиши, в чем их ключевое различие и почему их применение в паре дает более полную картину, чем по отдельности?
4. Описанные тестовые туры оформи в файле *task\_5.md.*
