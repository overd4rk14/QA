...
- [Глава 3](#глава-3)
    ...
    - [Тест-план](#тест-план)
    - [Задание 3. Разработка тест-плана](#задание-3-разработка-тест-плана)
- [Глава 4](#глава-4)
    - [Вспомогательные тестовые артефакты](#вспомогательные-тестовые-артефакты)
    - [Чит-лист](#чит-лист)
    - [Задание 4. Дополнить чек-лист из задания 2](#задание-4-дополнить-чек-лист-из-задания-2)
    - [Тестовые данные](#тестовые-данные)
    - [Задание 5. Тестовые данные](#задание-5-тестовые-данные)
    - [Тестовый сценарий](#тестовый-сценарий)
    - [Задание 6. Составить тестовый сценарий](#задание-6-составить-тестовый-сценарий)
...
2. Составь тест-кейс на негативную проверку (тут не ограничиваем твою фантазию авторизацией. Можно проверить UI (интерфейс), поля ввода, работу подсказок при неправильных действиях пользователя и т. д.).
3. Сделай несколько скриншотов процесса проверки позитивного и негативного сценариев (виден твой процесс проверки). 
4. Выполненное задание и скриншоты оформи в файле *task\_1.md.*
...
![checklist](misc/images/checklist.png)
...
1. Перейди на сайт «Школы 21» в раздел [«Как мы учим»](https://21-school.ru/methodology) и составь чек-лист  (минимум 5 проверок) на данный раздел.
